...
```json
"scripts": {
  "postinstall": "soroban contract bindings ts --rpc-url https://soroban-testnet.stellar.org --network-passphrase \"Test SDF Network ; September 2015\" --id CALNJGO4OMS6PCZIW3HFGDIDFMDCH6YODCOE5SRVQ7EVSCUKWESJ5OIM --name bindings"
}
```
